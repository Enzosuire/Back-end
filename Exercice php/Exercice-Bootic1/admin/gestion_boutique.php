...
try {
    ...
    <div class="col-12 text-center">
      <button class="btn btn-dark mx-auto"><a class="text-light text-decoration-none" href="gestion_produit.php?action=C&id=$value[0]">Ajouter un Produit</a></button>
    </div>
    </div>');
    $res = $req->fetchAll();
  ...
  <tbody >
    ...
    <tr>
      ...
      <td class= "text-center" colspan="2"><img src="../inc/img/'.$value[8].'" width="80rem"  "class="card-img-top mt-3 " alt="..." ></td >
    ...
    <tr>
      ...
      <td class= "text-center" colspan="2"><a href="gestion_produit.php?action=U&id='.$value[0].'" class="text-decoration-none text-dark"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-database-add" viewBox="0 0 16 16">
