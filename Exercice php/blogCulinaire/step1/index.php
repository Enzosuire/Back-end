        ...
        <div class="row">
            ...
            foreach ($recipes as $miam) { ?>
                <div class="col-sm-12 col-md-4">
                    <div class="card" style="width: 18rem;">
                        <img src="./../images/<?= $miam['rec_miniature'];  ?>" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title"><?= $miam['rec_nom']; ?></h5>
                            <p class="card-text"><?= $miam['rec_resume']; ?></p>
                            <a href="single.php?id=<?= $miam['rec_id']; ?>" class="btn btn-warning">Voir la recette</a>
                        </div>
                    </div>
                </div>
            <?php } ?>
                            ...
                            <?php } else { ?>
                                ...
                                <div class="row d-flex justify-content-center">
                                    <div class="col-lg-8 text-center">
                                        ...
                                        <p>
                                            <img class="rounded-circle shadow-1-strong mb-4" src="./../images/<?= $tuples['rec_miniature'] ?>" alt="avatar" style="width: 150px;" />
                                        </p>
